            ...
            <Box
                ...
                <Container
                    ...
                    <SimpleGrid
                        ...
                        spacing={8}>
                        <Stack display={{ base: "none", md: "flex" }} justify={{ md: "start", lg: "end" }} spacing={6}>
                            <Image w={40} src={logo} alt='logo' />
                            <Text fontSize={'sm'}>With lots of unique blocks, you can easily build a page without coding. Build your next landing page.</Text>
                            <HStack>
                        ...
                        <Stack align={'flex-start'}>
                            <Text fontWeight={'500'} fontSize={'lg'} mb={2}>Quick Link</Text>
                            <Link to={'/'}>
                                Home
                            </Link>
                            <Link to={'/products'}>
                    ...
                    <Stack display={{ base: "block", md: "none" }} justify={'end'} spacing={6}>
                        <Text fontSize={'sm'}>With lots of unique blocks, you can easily build a page without coding. Build your next landing page.</Text>
                        <HStack mt={4}>
                            <SocialLinks Icon={<FaLinkedinIn />}
                                Link={'#'} />
